<?php
    ...
    $ML = explode(", ", "Isabel Carter, Jonathon Yang, Oscar Yasunaga, Lucas Ren, Charles Yang, Robert Sun, Gerry Ma");
    ...
    $sigs = array("Music Production", "United Herald", "Machine Learning", "Visual Graphics", "Filmaking", "Game Dev", "DMS", "Live Stream");
    // print_r($people);
